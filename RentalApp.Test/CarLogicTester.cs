...
internal class CarLogicTester : MockRepository
{
    ...
    [Test]
    public async Task GetCarsFromYearAsync()
    {
        var actual = await carLogic.GetCarsFromYearAsync(2018);
    ...
    [Test]
    public async Task GetCarsByMakeAsync()
    {
        var actual = await carLogic.GetCarsByMakeAsync("make1");
    ...
    [Test]
    public async Task GetMostExpensiveAsync()
    {
        var actual = await carLogic.GetMostExpensiveAsync(2);
    ...
    [Test]
    public async Task GetLeastExpensiveAsync()
    {
        var actual = await carLogic.GetLeastExpensiveAsync();
    ...
    [Test]
    public async Task GetNotMaintainedAsync()
    {
        var actual = await carLogic.GetNotMaintainedAsync();
